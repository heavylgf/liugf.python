        ...
        for line in f:
            ...
            for databasetablelabel in databasetablelabels:
                ...
                if label == 'day':
                    ...
                    your_collection = mongoDF.agg({"count": "sum"}).collect()[0][0]
                    print("your_collection : " + str(your_collection))

                    your_max_value = mongoDF.agg({"count": "max"}).collect()[0][0]
                    print("your_max_value : " + str(your_max_value))

                    # mylogger.warn("hiveDF：" + hiveDF)
                    mylogger.warn("collection_sum_value：" + str(your_max_value))
                    ...
                    # result = 100 - your_collection
                    # print(result)


                    # if your_max_value > 2000:
                    #     logger.error("mongo_collection：" + mongo_collection + " , result" + result)
